...
- v0.1.0, v0.1.1, v0.2.0, v0.3.0, v0.3.1, v0.4.0, v0.5.0, v0.6.0, v0.7.0, v0.8.0, v0.9.0, v1.0.0, and v1.0.1 are published. Do not write about them as if they are pending, unreleased, or in release-candidate status.
- v1.0.1 is the current public release. The next release is not yet scheduled.
