...
- v0.3.1 (released) Workcells Hardening fixes child handoff contract, transition gates, configuration enforcement, scope validation, retry surfaces, and task specification hardening.
- v0.4.0 (released) Challenge Chamber adds independent specialized reviewers, severity, fix/re-review loops, and review evidence packages.
- v0.5.0 (released) Isolation adds branches, worktrees, baseline proof, rollback, cleanup, and backend adapters.
- v0.6.0 (released) Tempering adds human-approved, provenance-linked learning proposals.
