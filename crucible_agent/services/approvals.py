...
from crucible_agent.domain.enums import ApprovalGate
from crucible_agent.domain.models import Approval, new_id, utc_now
from crucible_agent.policy.stage_rules import HUMAN_APPROVAL_SOURCES, NON_HUMAN_ACTORS
