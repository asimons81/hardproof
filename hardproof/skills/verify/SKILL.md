---
name: verify
description: Prove a Hardproof implementation during VERIFY by running configured checks and evaluating fresh workspace-bound evidence.
---
...
2. Invoke `hardproof_verify`; do not substitute an unrecorded terminal run.
...
## Verification
Use `hardproof_report` to inspect evidence freshness, then call `hardproof_transition` for DELIVER.
