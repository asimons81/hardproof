---
name: deliver
description: Prepare an inspectable Hardproof delivery during DELIVER with final scope, evidence, risks, rollback, and reproducible reporting.
---
...
5. Generate the completion draft with `hardproof_report` and record it through `hardproof_record` when required.
...
## Verification
Reopen the generated report and linked evidence, then call `hardproof_transition` for LEARN.
