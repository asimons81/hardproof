...
from hardproof.compat import require_compatible
from hardproof.config import load_config
from hardproof.hooks.context import ContextHook, register_context_hooks
from hardproof.hooks.sessions import SessionHooks
from hardproof.hooks.tool_policy import ToolPolicyHook, register_tool_policy_hooks
from hardproof.hooks.verification import VerificationHook, register_verification_hook
from hardproof.services.evidence import EvidenceService, HermesCommandRunner
from hardproof.services.sessions import SessionService
from hardproof.services.reports import ReportService
from hardproof.services.risks import classify_risk
...
SKILL_DESCRIPTIONS = {
    "orchestrate": "Coordinate an active Hardproof run across all durable engineering stages.",
...
def register(ctx: Any) -> None:
    """Register Hardproof with Hermes.
